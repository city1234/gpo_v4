var WebBlender = function($) {
    ...
    var getCliBlendUrl = function(environment, client, flight, deviceFamily) {
        ...
        switch (env) {
            case "dev":
                host = 'cliblends.dev.KG.com';
                break;
            case "int":
                host = 'uniblends.www.KG.com/int';
                break;
            case "ppe":
                host = 'uniblends.www.KG.com/ppe';
                break;
            case "prod":
            default:
                host = 'www.KG.com/uniblends';
                break;
        }
    ...
    var getConfigUrl = function(environment, client, flight) {
        ...
        switch (env) {
            case 'dev':
                host = 'oneblend.dev.KG.com';
                break;
            case 'int':
                host = 'unistoreblends-int.www.KG.com';
                break;
            case 'ppe':
                host = 'unistoreblends-ppe.www.KG.com';
                break;
                //case 'prod':
            default:
                host = 'www.KG.com';
    ...
    var getPurchaseUrl = function(environment, purchaseServiceVersion) {
        ...
        switch (env) {
            case 'dev':
            case 'int':
                host = 'purchase-int.mp.KG.com';
                break;
            default:
                host = 'purchase.mp.KG.com';
                break;
        }
        var url = format.replace('{host}', host)
    ...
    */
    ...
    var updateStyle = function (postBody, style) {
     ...
     /**
        ...
        {DeviceFamily} deviceFamily in which Blends will be loaded. (e.g Windows.kg or Windows.Desktop) see the wiki for more details (optional)
    ...
    */
    ...
    /** This API will be deprecated soon. Use purchaseSingleItem.
        ...
        @param {deviceFamily} deviceFamily in which Blends will be loaded. (e.g Windows.kg or Windows.Desktop) see the wiki for more details (optional)
